...
import com.popop.lifesimulator.data.database.*
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideCharacterDao(database: GameDatabase): CharacterDao = database.characterDao()
    ...
    @Provides
    @Singleton
    fun provideGameLogDao(database: GameDatabase): GameLogDao = database.gameLogDao()
    ...
    @Provides
    @Singleton
    fun provideAssetDao(database: GameDatabase): AssetDao = database.assetDao()
    ...
    @Provides
    @Singleton
    fun provideLogger(dao: GameLogDao, scope: CoroutineScope): Logger = Logger(dao, scope)
